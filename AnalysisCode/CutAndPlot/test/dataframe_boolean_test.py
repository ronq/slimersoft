...
def boolFrame(df):
    ...
    print df['dummy']
    return df['dummy']
def LogicalAnd(dataFrameArray):
        """ Compute the logical AND of an array of DataFrames
        """
        return dataFrameArray.pop() & LogicalAnd(dataFrameArray) 
